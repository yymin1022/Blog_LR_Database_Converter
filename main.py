...
for dataItem in dataJson:
    doc_ref = db.collection(u"Blog Post").document(str(num))
    doc_ref.set({
...
num = 1
for dataItem in dataJson:
    doc_ref = db.collection(u"Project Post").document(str(num))
    doc_ref.set({
        u"isPinned": dataItem["pinned"],
        u"date": dataItem["postDate"],
        u"tag": dataItem["postTag"],
...
num = 1
for dataItem in dataJson:
    doc_ref = db.collection(u"Solving Post").document(str(num))
    doc_ref.set({
        u"isPinned": dataItem["pinned"],
        u"date": dataItem["postDate"],
        u"tag": dataItem["postTag"],
